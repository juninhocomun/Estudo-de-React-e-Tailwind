...
function Clover() {
  ...
  function tagToCornerToggle() {
    setCloverContainerAnimation(!cloverContainerAnimation);
    setCloverLeaftAnimation(
      cloverLeaftAnimation ? true : !cloverLeaftAnimation
    );
  }
  useEffect(() => {
  ...
  return (
    <div
      ...
      id="clover-container"
    >
      <button onClick={tagToCornerToggle}></button>
      <div
        className={`${
          cloverLeaftAnimation
